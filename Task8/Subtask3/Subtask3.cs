...
namespace Course.Task8
{
    class Subtask3
    {
        ...
        public Subtask3(params Product[] products)
        {
            this.products = new List<Product>();
            this.products.AddRange(products ?? null);
        }

        public Subtask3(string filePath)
        {
            products = new List<Product>();
        Start:
            try
        ...
        public List<Product> Except(Subtask3 b)
        {
            return products.Except(b.products).ToList();
        }

        public List<Product> Intersect(Subtask3 b)
        {
            return products.Intersect(b.products).ToList();
        }
        
        public List<Product> Union(Subtask3 b)
        {
            return products.Union(b.products).ToList();
        }
